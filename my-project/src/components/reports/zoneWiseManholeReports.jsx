...
//     }
//     setIsLoading(true);
//     const payload = { selectedManholes, userInputs, zone, formatDateRange, command: "generate_manhole_report" };
...
//       {/* Main UI Container */}
//       <div className="bg-white rounded-lg mx-[20px] p-[24px] border-[1.5px] border-[#E1E7EF] sm:p-6 max-h-[550px] h-[550px] flex flex-col relative">
//         {/* --- Header Section (UI is IDENTICAL to your original code) --- */}
...
//                 />
//                 Select All on Page {/* Text updated for clarity */}
//               </label>
//             </div>
//           </div>
